...
const Filters = () => {
    ...
    return(
        <div
        className="w-full h-12 border-2 border-2 border-gray-100 rounded-lg
        flex items-center justify-content relative
        "
        >
            <Search/>
            <div className="flex mr-7">
                ...
                >
                    ...
                    pl-2 required outline-0 border-transparent
