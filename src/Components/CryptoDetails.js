...
const HighLowIndicator = ({currentPrice, high,low}) => {
    ...
    return(
        <>
        <span
        className="bg-red h-1.5 rounded-1-lg w-[50%]"
        ...
        <span
        className="bg-green h-1.5 rounded-1-lg w-[50%]"
        style={{width: `${green}%`}}
        >
            &nbsp;
        </span>
...
const CrytoDetails = () => {
    ...
    return ReactDOM.createPortal(
        <div
        className="fixed top-0 w-full h-full bg-opacity-30 first-letter:
                            ...
                            <div className="flex w-full mt-6">
                                <div className="flex flex-col w-full">
                                    <div className="flex justify-between">
                                        ...
                                        >
                                            ...
                                            className={`
                                                w-[1rem] ml-0.5
                                                ${
                                                    data.market_dat.price_change_percentage_24h > 0
                                    ...
                                    <h2 className="text-lg font-bold">
                                        ...
                                        }).format(data.market_data.currency_price[currency])}
                                    </h2>
                                </div>
                            </div>
                    ...
                    <div className="flex w-full mt-4 justify-between">
                        <div className="flex flex-col">
                            ...
                            {data?.links?.official_forum_url[0] && (
                                ...
                                target={"_blank"}
                                rel="noreferrer"
                                className="text-sm bg-gray-200 text-gray-100 px-1.5 py-0.5 my-1 rounde"
                        ...
                        <div className="flex flex-col content-start">
                            ...
                            <div className="text justify-between">
                                ...
                                className="flex justify-between">
                                    <div className={`text-sm px-1 ml-1 font-medium flex items-center
                                    ...
                                    >
                                        ...
                                        viewBox="0 0 14 14"
                                        fill="none"
                                        xmnlns="https://www.w3.org/2000/svg"
                                        className={`
                                        w-[1rem] ml-0.5
                                        fill-green rotate-180
                      `}
