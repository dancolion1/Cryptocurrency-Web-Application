...
import paginationArrows from "../assets/pagination-arrows.svg";
                ...
                <ul className="flex items-center justify-end text-sm">
                    ...
                    {page - 1 !== 0 ? (
                        <li>
                            <button
                            onClick={prev}
                            className="outline-0 hover:text-cyan rounded-full w-8 h-8 flex"
                            >
                                {" "}
                                {page - 1}{" "}
                            </button>
                    ...
                    <li>
                        <button
                        diasabled
                        className="outline-0 rounded-full w-8 h-8 flex-center justify-center bg-cyan text-gray-300 mx-1.5"
                        >
                            {page}
                        </button>
                    ...
                    {page !== TotalNumber ? (
                        <li>
                            ...
                            className="outline-0 hover:text-cyan rounded-full w-8 h-8 flex iems-center justify-center bg-gray-200 mx-1.5"
                           >
                            {TotalNumber}
                            </button> 
                        </li>
